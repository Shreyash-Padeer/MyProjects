...
void ls_file()
{
    ...
    {
        printf("Error : There are no visible files\n");
        return;
    }
...
int main()
{
    ...
    while(1)
    {
        ...
        count = sscanf(str,"%s %s %s %s",command[0],command[1],command[2],command[3]);  // string tokenization   // strtok()
        ...
        if(count == 1)
        {
            ...
            {
                printf("Terminating the SP Virtual File System\n");
                break;
            }
            else
            {
...
stat marellous.txt
man write
write marvellous.txt
Hello world India
stat marvellous.txt
man read
read marvellous.txt 5
man rm
ls
rm marvellous.txt
ls
...
// GetFDFromName madhe tumhala condition handle karav lagnar ahe